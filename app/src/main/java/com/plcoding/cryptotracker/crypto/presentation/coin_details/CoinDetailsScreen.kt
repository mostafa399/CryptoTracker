...
fun CoinDetailsScreen(
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            Icon(
                imageVector =
                ImageVector.vectorResource(id = coin.iconRes), contentDescription = coin.name,
            ...
            AnimatedVisibility(visible = coin.coinPriceHistory.isNotEmpty()) {
                ...
                val startIndex =
                    (coin.coinPriceHistory.lastIndex - ammountOfVisibleDataPoints)
                        .coerceAtLeast(0)
                LineChart(
                    dataPoint = coin.coinPriceHistory,
                    style = ChartStyle(
